...
urlpatterns = [
    ...
    path('group/<str:chatroom_name>/leave/', leave_group, name='group-leave'),
    path('group/<str:chatroom_name>/add-member/', add_group_member, name='group-add-member'),
    path('group/<str:chatroom_name>/delete/', delete_group, name='group-delete'),
    path('group/<str:chatroom_name>/', group_chat_view, name='group-chat'),
